...
import ar.davinci.edu.fragments.ExerciseFragment;
import ar.davinci.edu.fragments.NutritionFragment;
...
public class RoutineAdapter extends BaseAdapter {
    ...
    public View getView(int i, View routineView, ViewGroup viewGroup) {
        ...
        btnExercise.setOnClickListener(v -> FragmentMng.changeFragments(context, exerciseFragment));
        btnNutrition.setOnClickListener(v -> FragmentMng.changeFragments(context, nutritionFragment));
