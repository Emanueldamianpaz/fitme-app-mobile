...
public class MealNutritionActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void bootstrapping() {
        ...
        MealNutritionFragment mealNutritionFragment = new MealNutritionFragment();
        args.putString("meal_nutrition", getIntent().getStringExtra("meal_nutrition"));
        mealNutritionFragment.setArguments(args);

        Helper.changeFragments(this, mealNutritionFragment);
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.my_account:
                startActivity(Helper.getIntent(this, MealNutritionActivity.class));
                break;
