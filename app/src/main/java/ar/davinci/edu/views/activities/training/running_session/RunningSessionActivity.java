...
public class RunningSessionActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void bootstrapping() {
        ...
        RunningSessionFragment runningSessionFragment = new RunningSessionFragment();
        args.putString("running_session", getIntent().getStringExtra("running_session"));
        runningSessionFragment.setArguments(args);

        Helper.changeFragments(this, runningSessionFragment);
    }
