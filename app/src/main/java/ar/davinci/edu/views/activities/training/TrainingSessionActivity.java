...
public class TrainingSessionActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void bootstrapping() {
        ...
        Helper.changeFragments(this, new TrainingSessionFragment());
    }
