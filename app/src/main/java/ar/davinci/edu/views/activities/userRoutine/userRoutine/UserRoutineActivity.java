...
public class UserRoutineActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void bootstrapping() {
        ...
        Helper.changeFragments(this, userRoutineFragment);
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.my_account:
                startActivity(Helper.getIntent(this, UserRoutineActivity.class));
                break;
