...
public class NutritionSessionActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public NutritionSessionActivity() {
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nutrition_session);
        bootstrapping();
    ...
    private void bootstrapping() {
        ...
        toolbar.setTitle("Entrenamiento - Comida ingerida");
        ...
        NutritionSessionFragment nutritionSessionFragment = new NutritionSessionFragment();
        args.putString("nutrition_session", getIntent().getStringExtra("nutrition_session"));
        nutritionSessionFragment.setArguments(args);

        Helper.changeFragments(this, nutritionSessionFragment);
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.begin_run:
                startActivity(Helper.getIntent(this, NutritionSessionActivity.class));
                break;
